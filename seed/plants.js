...
const main = async () => {
  const plants = [
    ...
    },
    {
      name: 'Cigar Flower',
      description:
        'Botanically called Cuphea ignea, cigar plant flowers bloom in full sun to partial shade. The small cigar plant shrub usually reaches no more than 24 inches',
      image:
        'https://www.gardeningknowhow.com/wp-content/uploads/2021/01/cigar-flowers-400x300.jpg'
    }
  ]
